import type { FormData, UserProfile, Scenario, QuantResult, ResearchResult, TradeoffMatrix, WhatIfDiff, DecisionBrief } from './types'
...
export async function submitWhatIf(sessionId: string, perturbation: string): Promise<{ diff: WhatIfDiff }> {
